...
\begin{figure}[H]
	...
	\subcaptionbox{sumando $k=10^4$ en costos}{\includegraphics[width=.3\linewidth]{r4.png}}
	\subcaptionbox{sumando $k=10^8$ en costos}	{\includegraphics[width=.3\linewidth]{r8.png}}
	\subcaptionbox{costos sin modificar (en azul), sumando $k=10^4$ (amarillo) y sumando $k=10^8$ (rojo)}{\includegraphics[width=.3\linewidth]{r48.png}}
